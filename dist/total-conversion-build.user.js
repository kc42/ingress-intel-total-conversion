...
// @version        0.7.7-2013-02-27-174759
...
window.iitcBuildDate = '2013-02-27-174759';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2013-02-27-174759');
...
window.reportPortalIssue = function(info) {
  ...
  if(prompt(t, info) !== null)
    window.open('https://support.google.com/ingress?hl=en&contact=1');
}
